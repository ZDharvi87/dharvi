...
<html lang="en">
  ...
  <body>
  <nav class="navbar navbar-expand-sm navbar-light bg-dark position-relative" aria-labelledby="navbar">
        ...
        <div class="row">
            <div class="col-lg-9 ml-auto">
                <div class="card">
                    ...
                    <table class="table table-striped" aria-describedby="user">
