            ...
            <ul class="navbar nav ml-auto">
                <li class="nav-item dropdown mr-3">
                    ...
                    <div class="dropdown-menu">
                        <a href="profile.html" class="dropdown-item text-decoration-none text-dark">
                            <em class="fa fa-user-circle"></em> Profile
                        </a>
                        <a href="setting.html" class="dropdown-item text-decoration-none text-dark">
...
<header id="main-header" class="bg-success text-white">
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-9">
                <h1><em class="fa fa-folder-open"></em> Category</h1>
            </div>
        </div>
    </div>
</header> <br>
        ...
        <div class="row">
            <div class="col-lg-9 ml-auto mr-auto">
                <div class="card">
                    ...
                    <table class="table table-striped" aria-describedby="category">
