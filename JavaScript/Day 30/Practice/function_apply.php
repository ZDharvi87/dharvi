  ...
  <?php include("../../../header.php") ?>
    <div class="row">
      ...
      <h2>Function call create employee object with field Name,
           Address and Designation and pass it to function.</h2>
           ...
           <input type="button" value="Submit" name="Submit" onclick="info()" class="btn btn-success">
           <h2 id="res" style="color: rgb(30, 123, 210);"></h2>
    <script>
        function info(){
            var employee ={
            ...
            document.getElementById("res").innerHTML =employee.information.apply(employee1);
        }
